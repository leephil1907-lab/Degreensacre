        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4 leading-relaxed">
              Nigeria&apos;s trusted property intelligence platform. Homes, land and investment opportunities worth knowing.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              ...
              <a
                ...
                className="flex items-center gap-2.5 bg-green-600 hover:bg-green-500 text-white px-4 py-2.5 rounded-lg font-semibold transition-all w-fit"
              >
              ...
              <a
                ...
                className="flex items-center gap-2.5 bg-forest/20 hover:bg-forest/30 border border-forest/30 text-white px-4 py-2.5 rounded-lg font-semibold transition-all w-fit"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                <div>
                  <span className="block text-xs text-gray-400 font-normal">Customer Support</span>
                  <span className="block">0806 501 9971</span>
                </div>
              </a>
              ...
              >
                ...
                <span className="text-xs">degreenacrespropertieslimited@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
