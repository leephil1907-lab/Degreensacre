...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Tooltip */}
      <div className="bg-white rounded-xl shadow-strong px-4 py-3 max-w-[220px] animate-fade-in hidden sm:block">
        <p className="text-sm text-charcoal font-medium">Need help finding a property?</p>
