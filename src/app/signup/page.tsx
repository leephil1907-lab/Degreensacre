...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Account created successfully! Please check your email to verify your account. (Supabase Auth integration pending)');
    }, 1000);
  };
  ...
  const handleGoogleSignUp = async () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Google Sign-Up will be functional after configuring Supabase OAuth. See SOCIAL-AUTH-IMPLEMENTATION.md for setup instructions.');
    }, 500);
  };
  ...
  const handleFacebookSignUp = async () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Facebook Sign-Up will be functional after configuring Supabase OAuth. See SOCIAL-AUTH-IMPLEMENTATION.md for setup instructions.');
    }, 500);
  };
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Join thousands of property investors across Nigeria
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  onClick={() => updateFormData('accountType', 'buyer')}
                ...
                <button
                  type="button"
                  onClick={() => updateFormData('accountType', 'seller')}
                  className={`p-4 rounded-lg border-2 text-sm font-semibold transition-all ${
            ...
            <div className="flex items-start">
              <input
                ...
                className="w-4 h-4 mt-1 text-forest border-gray-300 rounded focus:ring-forest"
              />
              <label htmlFor="agreeTerms" className="ml-2 text-sm text-gray-600">
                I agree to the{' '}
                <Link href="/terms" className="text-forest hover:text-forest-light font-semibold">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link href="/privacy" className="text-forest hover:text-forest-light font-semibold">
                  Privacy Policy
                </Link>
              </label>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-soft p-6">
          <h3 className="font-bold text-charcoal mb-4">Why Join De-Greenacres?</h3>
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-start gap-2">
              ...
              <span>Access verified properties across Nigeria</span>
            </li>
            <li className="flex items-start gap-2">
              <svg className="w-5 h-5 text-forest flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span>Save favorite properties and get alerts</span>
            </li>
            <li className="flex items-start gap-2">
              <svg className="w-5 h-5 text-forest flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span>Use investment calculators and tools</span>
            </li>
            <li className="flex items-start gap-2">
              <svg className="w-5 h-5 text-forest flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span>Connect directly with verified agents</span>
            </li>
          </ul>
        </div>
