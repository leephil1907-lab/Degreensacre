            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-soft p-6">
                ...
                <div className="space-y-2">
                  <a href="tel:+2348065019971" className="block text-gray-600 hover:text-magenta transition-colors font-medium">
                    +234 806 501 9971
                  </a>
                  <a href="tel:+2349019394204" className="block text-gray-600 hover:text-magenta transition-colors font-medium">
                    +234 901 939 4204
                  </a>
                  <a href="tel:+2348039388397" className="block text-gray-600 hover:text-magenta transition-colors font-medium">
                    +234 803 938 8397
                  </a>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-soft p-6">
                ...
                <div className="space-y-2">
                  <a href="mailto:de_greenacrespropertiesltd@yahoo.com" className="block text-gray-600 hover:text-magenta transition-colors">
                    de_greenacrespropertiesltd@yahoo.com
                  </a>
                </div>
              </div>
